    ...
    <div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
        ...
        <div style="min-height: 100vh;" class="font-sans back bg-cover pt-14 md:pt-0 md:ml-64 w-full">
            <div class="w-full mx-auto h-full flex flex-col" style="min-height: 90vh;">
                <div class="py-4 px-4 bg-gray-600 text-white font-semibold">Édition d'un citoyen</div>
                <a href="/citizen/citizens.php" class="ml-auto mr-12 md:mr-20 lg:mr-32 my-6 px-4 py-1 text-gray-900 font-light tracking-wider bg-gray-100 hover:bg-gray-200 rounded" type="submit">Retour</a>
