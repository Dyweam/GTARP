    ...
    <?php include_once('../component/navbar.php') ?>
        ...
        <div style="min-height: 100vh;" class="font-sans back bg-cover pt-14 md:pt-0 md:ml-64 w-full">
            <div class="w-full mx-auto h-full flex flex-col" style="min-height: 90vh;">
                <div class="py-4 px-4 bg-gray-600 text-white font-semibold">Citoyens</div>
                <a href="/citizen/citizenAdd.php" class="ml-auto my-6 mx-12 px-4 py-1 text-gray-900 font-light tracking-wider bg-gray-100 hover:bg-gray-200 rounded" type="submit">Ajouter un citoyen</a>
                ...
                <div class="md:mx-12 md:rounded p-6 bg-white border-b border-gray-200">
                    <div class="flex items-center px-4">
                        ...
                        <div class="ml-3">
                            <div class="font-medium text-base text-gray-800">Jean Castex</div>
                            <div class="font-medium text-sm text-gray-500">32 ans</div>
                        </div>
                    </div>
                    ...
                    <div class="ml-3" style="display: flex; margin: auto;">
                        <div class="p-2" style="margin: 0 0 0 auto;">
                            <a href="/citizen/citizenEdit.php" type="submit" class="items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs">
